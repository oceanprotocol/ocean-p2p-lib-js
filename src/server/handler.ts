import { P2PCommandResponse } from "../@types/p2p"
import { CORE_LOGGER } from "../logging/common"
import { ICommandHandler, Command } from "./commands"
import { getConfiguration } from "./config"
import { ReadableString } from "./handleProtocolCommands"
import { ValidateParams, buildRateLimitReachedResponse, buildInvalidParametersResponse } from "./httpRoutes/validateCommands"
...
export abstract class Handler implements ICommandHandler {
    ...
    public constructor(oceanNode: any) {
